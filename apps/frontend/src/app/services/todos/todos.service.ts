...
import { CreateTodoInput, DeleteTodoInput, GetTodosInput, GetTodosResponse, Todo, UpdateTodoInput } from '../../store/todos/todos.models';
...
export class TodosService {
  ...
  async fetchTodos(props?: GetTodosInput) {
    const todos = (await this.apiService.api.get<GetTodosResponse>('/todo', { params: props })).data;
    return todos;
  }
